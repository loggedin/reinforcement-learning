...
class HIVSimulator(object):
    ...
    **REFERENCE:**
    ...
    def __init__(self, logspace=True, dt=5, model_derivatives=None, perturb_params=True,p_init = np.zeros(6), \
    ...
    def calc_reward(self, action=0, state=None):
        ...
        #return np.log(reward + self.reward_bound)
        return reward/10000
    ...
    def perform(self, action, perturb_params=False, p_lambda1=0, p_lambda2=0, p_k1=0, \
